                                    ...
                                    <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                                        ...
                                        <tr>
                                            <td bgcolor="white" class="databaseListItem">
                                                ...
                                                <asp:Button id="CreateNewTableButton" runat="server" CSSClass="button" onMouseOver="this.style.color='#808080';" onMouseOut="this.style.color='#000000';" Text="Create" onclick="CreateNewTableButton_Click"></asp:Button>
                                                <br>
                                                <br>
