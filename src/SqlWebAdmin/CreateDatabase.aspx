                                    ...
                                    <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                                        ...
                                        <tr>
                                            <td bgcolor="white" class="databaseListItem">
                                                ...
                                                <asp:Button id="CreateNewDatabaseButton" runat="server" CSSClass="button" onMouseOver="this.style.color='#808080';" onMouseOut="this.style.color='#000000';" Text="Create" onclick="CreateNewDatabaseButton_Click"></asp:Button>
                                                <br>
                                                <br>
                                                <asp:RequiredFieldValidator Runat="server" ID="DatabaseNameRequiredValidator" ControlToValidate="DatabaseNameTextBox" Display="Dynamic" ErrorMessage="The database name cannot be empty."></asp:RequiredFieldValidator>
