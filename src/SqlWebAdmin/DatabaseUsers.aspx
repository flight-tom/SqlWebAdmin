                                            ...
                                            <td bgcolor="white" class="databaseListItem">
												...
												>
													...
													<Columns>
														...
														<asp:TemplateColumn>
															<ItemTemplate>
																<a href='EditDatabaseUser.aspx?database=<%=Request["database"]%>&user=<%#((SqlUser)Container.DataItem).Name%>'>Edit</a>
															</ItemTemplate>
														</asp:TemplateColumn>
														<asp:TemplateColumn>
															<ItemTemplate>
																<a href='DeleteDatabaseUser.aspx?database=<%=Request["database"]%>&user=<%#((SqlUser)Container.DataItem).Name%>'>Delete</a>
															</ItemTemplate>
														</asp:TemplateColumn>
													</Columns>
												</asp:DataGrid>
